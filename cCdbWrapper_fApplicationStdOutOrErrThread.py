...
def cCdbWrapper_fApplicationStdOutOrErrThread(oCdbWrapper, uProcessId, sBinaryName, sCommandLine, oStdOutOrErrPipe, sStdOutOrErr):
  while 1:
    try:
    ...
    oCdbWrapper.fApplicationStdOutOrErrOutputCallback(uProcessId, sBinaryName, sCommandLine, sStdOutOrErr, sLine);

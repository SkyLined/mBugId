...
IF EXIST "%~dp0\..\mProductVersionAndLicense\License.py" (
  %PYTHON% "%~dp0\..\mProductVersionAndLicense\License.py" register --product="%~dp0." --license="%~1"
) ELSE IF EXIST "%~dp0\modules\mProductVersionAndLicense\License.py" (
  %PYTHON% "%~dp0\modules\mProductVersionAndLicense\License.py" register --product="%~dp0." --license="%~1"
) ELSE (

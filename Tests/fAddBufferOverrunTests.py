...
def fAddBufferOverrunTests(dxTests):
  srAccessIdAndLocation = r"f3d\.5b3 @ bugidtests.exe!fAccessHeapOrStackMemoryBlock";
  srWriteStackIdAndLocation = r"f3d @ bugidtests.exe!fAccessHeapOrStackMemoryBlock"; # stack will be corrupt, so only one function on it.
  ...
  dxTests["BufferOverrun"] = {
    "Heap": {
      "Read": [
        ...
        (NORMAL, [0xC, 5], [r"OOBR\[4n\]\+4n " + srAccessIdAndLocation],                 nExpectedTestTimeOnX64),
        (FULL,   [0xD, 5], [r"OOBR\[4n\+1\]\+3 " + srAccessIdAndLocation,
                            r"OOBR\[4n\+1\]\+4n " + srAccessIdAndLocation],              nExpectedTestTimeOnX64),
        (FULL,   [0xE, 5], [r"OOBR\[4n\+2\]\+2 " + srAccessIdAndLocation,
                            r"OOBR\[4n\+2\]\+3 " + srAccessIdAndLocation],               nExpectedTestTimeOnX64),
        (FULL,   [0xF, 5], [r"OOBR\[4n\+3\]\+1 " + srAccessIdAndLocation,
                            r"OOBR\[4n\+3\]\+2 " + srAccessIdAndLocation],               nExpectedTestTimeOnX64),
      ],
      "Write": [
        ...
        (NORMAL, [ 0xC, 5], [r"BOF\[4n\]\+4n\{\+0~4n\} " + srAccessIdAndLocation,
                              r"BOF\[4n\]\{\+0~4n\} " + srFreeIdAndLocation],            nExpectedTestTimeOnX64),
        ...
        (FULL,   [ 0xD, 5], [r"BOF\[4n\+1\]\+3\{\+0~3\} " + srAccessIdAndLocation,
                              r"OOBW\[4n\+1\]\+4n\{\+0~3\} " + srAccessIdAndLocation],   nExpectedTestTimeOnX64),
        (FULL,   [ 0xE, 5], [r"BOF\[4n\+2\]\+2\{\+0~2\} " + srAccessIdAndLocation,
                              r"OOBW\[4n\+2\]\+3\{\+0~2\} " + srAccessIdAndLocation],    nExpectedTestTimeOnX64),
        (FULL,   [ 0xF, 5], [r"BOF\[4n\+3\]\+1\{\+0~1\} " + srAccessIdAndLocation,
                              r"OOBW\[4n\+3\]\+2\{\+0~1\} " + srAccessIdAndLocation],    nExpectedTestTimeOnX64),
        # For this buffer overflow, there is no heap block suffix in which to detect corruption, so it cannot be
        # detected as a BOF.
        (FULL,   [0x10, 5], [r"OOBW\[4n\]\+0 " + srAccessIdAndLocation,
                              r"OOBW\[4n\]\+1 " + srAccessIdAndLocation],                nExpectedTestTimeOnX64),
      ],
    },
    "Stack": {
      "Write": [
        ...
        (NORMAL, [0x10, 0x200], [r"OOBW:Stack " + srWriteStackIdAndLocation],            nExpectedTestTimeOnX64),
        ...
        # (NORMAL, [0x10, 0x100000], [r"AVW\[Stack\]\+0 " + srAccessIdAndLocation],      nExpectedTestTimeOnX64),
      ],
    },
  };

  ...
  dxTests["BufferOverrun"] = {
    "Heap": {
      "Read": [
        ...
        (NORMAL, [0xC, 5], [r"OOBR\[4n\]\+4n (3ae\.540|3f0\.80a) @ <binary>!fuReadByte"]),
        (FULL,   [0xD, 5], [r"OOBR\[4n\+1\]\+3 (3ae\.540|3f0\.80a) @ <binary>!fuReadByte",
                            r"OOBR\[4n\+1\]\+4n (3ae\.540|3f0\.80a) @ <binary>!fuReadByte"]),
        (FULL,   [0xE, 5], [r"OOBR\[4n\+2\]\+2 (3ae\.540|3f0\.80a) @ <binary>!fuReadByte",
                            r"OOBR\[4n\+2\]\+3 (3ae\.540|3f0\.80a) @ <binary>!fuReadByte"]),
        (FULL,   [0xF, 5], [r"OOBR\[4n\+3\]\+1 (3ae\.540|3f0\.80a) @ <binary>!fuReadByte",
                            r"OOBR\[4n\+3\]\+2 (3ae\.540|3f0\.80a) @ <binary>!fuReadByte"]),
      ],
      "Write": [
        # These issues are detected when they cause an access violation, but earlier
        # OOBWs took place that did not cause AVs. This causes memory corruption, which
        ...
        (NORMAL, [ 0xC, 5], [r"BOF\[4n\]\+4n\{\+0~4n\} (975\.540|113\.80a) @ <binary>!fWriteByte",
                              r"BOF\[4n\]\{\+0~4n\} (540|80a) @ <binary>!wmain"]),
        ...
        (FULL,   [ 0xD, 5], [r"BOF\[4n\+1\]\+3\{\+0~3\} (975\.540|113\.80a) @ <binary>!fWriteByte",
                              r"OOBW\[4n\+1\]\+4n\{\+0~3\} (975\.540|113\.80a) @ <binary>!fWriteByte"]),
        (FULL,   [ 0xE, 5], [r"BOF\[4n\+2\]\+2\{\+0~2\} (975\.540|113\.80a) @ <binary>!fWriteByte",
                              r"OOBW\[4n\+2\]\+3\{\+0~2\} (975\.540|113\.80a) @ <binary>!fWriteByte"]),
        (FULL,   [ 0xF, 5], [r"BOF\[4n\+3\]\+1\{\+0~1\} (975\.540|113\.80a) @ <binary>!fWriteByte",
                              r"OOBW\[4n\+3\]\+2\{\+0~1\} (975\.540|113\.80a) @ <binary>!fWriteByte"]),
        ...
        (FULL,   [0x10, 5], [r"OOBW\[4n\]\+0 (975\.540|113\.80a) @ <binary>!fWriteByte",
                              r"OOBW\[4n\]\+1 (975\.540|113\.80a) @ <binary>!fWriteByte"]),
      ],
    },
    "Stack": {
      "Write": [
        # Stack based heap overflows can cause an access violation if the run off the
        # end of the stack, or a debugbreak when they overwrite the stack cookie and
        ...
        (NORMAL, [0x10, 0x200], [r"OOBW:Stack (540|80a) @ <binary>!wmain"]),
        ...
        # TODO: Reimplement pageheap and add feature that adds guard pages to all
        # virtual allocations, so stacks buffer overflows are detected as soon as they
        # read/write past the end of the stack.
        # (NORMAL, [0x10, 0x100000], [r"AVW\[Stack\]\+0 (975\.540|113\.80a) @ <binary>!fWriteByte"]),
      ],
    },
  };

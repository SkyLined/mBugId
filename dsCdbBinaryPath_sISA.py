...
dasPotentialCdbBinaryPaths_sISA["x86"].extend([
  ...
  os.path.join(sProgramFilesPath_x86, "Windows Kits", "8.1", "Debuggers", "x86", "cdb.exe"),
]);
if sOSISA == "x64":
  dasPotentialCdbBinaryPaths_sISA["x64"].extend([
    os.path.join(sProgramFilesPath_x64, "Windows Kits", "10", "Debuggers", "x64", "cdb.exe"),
    os.path.join(sProgramFilesPath_x64, "Windows Kits", "8.1", "Debuggers", "x64", "cdb.exe"),
    os.path.join(sProgramFilesPath_x86, "Windows Kits", "10", "Debuggers", "x64", "cdb.exe"),
    os.path.join(sProgramFilesPath_x86, "Windows Kits", "8.1", "Debuggers", "x64", "cdb.exe"),
  ]);

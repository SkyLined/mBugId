...
dtsTypeId_and_sSecurityImpact_by_uExceptionCode = {
  ...
  STATUS_ILLEGAL_INSTRUCTION:       ("IllegalInstruction",    "May be a security issue, if the instruction pointer was corrupted"),
  STATUS_INVALID_LOCK_SEQUENCE:     ("InvalidLockSequence",   "Unknown"),
